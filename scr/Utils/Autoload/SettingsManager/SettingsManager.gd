...
var difficulties = ["Easy", "Normal", "Hard", "Unreal"] # Список режимов сложности
...
var boss_inaccuracy_settings = {
	...
	"Hard": {"min_ang": 3.0, "max_ang": 8.0, "interval": 0.5},
	"Unreal": {"min_ang": 0.0, "max_ang": 0.0, "interval": 0.3}
}

var enemies_inaccuracy_settings = {
	"Easy": {"min_ang": 7.0, "max_ang": 10.0, "interval": 0.7},
	"Normal": {"min_ang": 3.0, "max_ang": 8.0, "interval": 0.5},
	"Hard": {"min_ang": 7.0, "max_ang": 15.0, "interval": 0.5},
	"Unreal": {"min_ang": 0.0, "max_ang": 0.0, "interval": 0.3}
}
...
# Получение текущего значения разброса врагов
func get_enemies_inaccuracy() -> Dictionary:
	return enemies_inaccuracy_settings[difficulty]
